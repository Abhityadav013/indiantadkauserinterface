    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-6 mt-8">
            <div className="relative min-h-[90px] border p-4 rounded-md bg-white">
                {/* Skeleton Layer */}
                <div
                    className={`absolute inset-0 transition-opacity duration-500 ease-in-out ${isPaymentElementReady ? 'opacity-0 pointer-events-none' : 'opacity-100'
                        }`}
                >
                ...
                <div className={`transition-opacity duration-500 ease-in-out ${isPaymentElementReady ? 'opacity-100' : 'opacity-0'}`}>
